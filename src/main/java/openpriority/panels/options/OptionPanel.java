...
public final class OptionPanel
{
    ...
    private static final class Components
    {
        private static Uniform panel()
        {
            ...
            Uniform root = BaseUniformBuilder.start(Alignment.HORIZONTAL)
        ...
        {
            Uniform optionsContent = BaseUniformBuilder.start(Alignment.VERTICAL)
        ...
        private static Uniform generalOptions()
        {
            ...
            Uniform localeSelection = BaseUniformBuilder.start(Alignment.HORIZONTAL)
                .withGap(20)
                .add(localeLabel, Priority.NEVER, Priority.ALWAYS)
                .add(localeSelect, Priority.ALWAYS)
                .build();

            Uniform localeHolder = BaseUniformBuilder.start(Alignment.HORIZONTAL)
                .withGap(20)
                .add(localeSelection)
        ...
        private static Uniform debugOptions()
        {
            ...
            Uniform buttons = BaseUniformBuilder.start(Alignment.HORIZONTAL)
                .defaultPriorities(Priority.SOMETIMES)
                .withGap(20)
